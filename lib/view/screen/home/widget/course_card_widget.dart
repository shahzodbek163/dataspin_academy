              ...
              child: SizedBox(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    fit: BoxFit.cover,
                    imageUrl:
                        "${AppIp.ip}/api/image/?id=${courseWithPriceData.course.previewPhoto.id}",
                  ),
                ),
              ),
            ),
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(width: 6.w),
                          Text(
                            "${courseWithPriceData.receptionCounter.totalCount}",
                            style: AppFonts.label,
                          ),
                          SizedBox(width: 6.w),
                        ],
                      ...
                      Text(
                        courseWithPriceData.price == null
                            ? "Kurs narxi : Belgilanmagan"
                            : "Kurs narxi : ${courseWithPriceData.price}",
